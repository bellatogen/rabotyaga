...
// role="progressbar" + aria-valuenow/min/max даёт скринридерам числовое значение,
// а не просто "изображение" (как role="img")
export function Ring({pct,color,top,bottom,label}){
  ...
  return(
    <svg viewBox="0 0 64 64" width="74" height="74"
      ...
      aria-valuenow={Math.round(Math.min(Math.max(pct,0),1)*100)}
      aria-valuemin={0}
      aria-valuemax={100}>
